...
-(void)viewDidLoad {
    ...
    self.controller = [[LBYouTubePlayerViewController alloc] initWithYouTubeURL:[NSURL URLWithString:@"http://www.youtube.com/watch?v=_AP90lJhLCg&feature=g-logo-xit"] quality:LBYouTubeVideoQualityLarge];
